...
def show_answers(index, guessed = False):
  ...
  if guessed:
    if correct == 'a':
      draw_text_button(20, 400, 760, 40, option_a, False)
    elif correct == 'b':
      draw_text_button(20, 450, 760, 40, option_b, False)
    elif correct =='c':
      draw_text_button(20, 500, 760, 40, option_c, False)
    else:
      draw_text_button(20, 550, 760, 40, option_d, False)
  else:
    click_on_a = draw_text_button(20, 400, 760, 40, option_a)
    click_on_b = draw_text_button(20, 450, 760, 40, option_b)
    click_on_c = draw_text_button(20, 500, 760, 40, option_c)
    click_on_d = draw_text_button(20, 550, 760, 40, option_d)
